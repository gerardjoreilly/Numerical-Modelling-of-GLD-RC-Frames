...
# in Italy. The full explanation and calibration of all the parameters required here can be found in
# O'Reilly [2016] in addition to any expressions needed to determine the parameters outlined here.
#
...
# to determine the shear behaviour are adopted from Zimos et al. [2015] and outlined in O'Reilly [2016] also.
#
#
# References:
...
# Could use the other proposed by Melo et al. [2015] here also.
...
# --------------------------------------
# Take the residual as 10% of the capping moment (OpenSees doesnt like 0, gives errors)
...
if {$ST<1} {
	...
	# Create the element with the shear springs at either end
