# --------------------------------------------------------------------------
# File to create a list of standardised units and the relevant conversions
# between different systems (i.e metric and imperial)
# --------------------------------------------------------------------------
# Written: Gerard J. O'Reilly
# IUSS Pavia, Italy
# February 2017

# This file is built in metric units of kN and m
